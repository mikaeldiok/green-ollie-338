...
@section('content')
            ...
            <div class="sm:col-span-2 grid grid-cols-2 sm:grid-cols-4 gap-6">
                @foreach ($foods as $food)
                    <div class="relative bg-white rounded-lg shadow-md overflow-hidden">
                        ...
                        <!-- Price and Button Group Stuck at the Bottom -->
                        <div class="absolute bottom-0 left-0 w-full bg-white pt-3 shadow-md text-center">
                            <div class="text-s font-semibold text-gray-900 mb-2" x-text="formatCurrency({{ $food->price }})">
                            </div>
                            ...
                            <div x-data="{ quantity: 0, added: false }" class="flex items-center justify-center">
                                <button x-show="!added"
                                    ...
                                    class="bg-blue-500 text-white px-4 py-2 border border-blue-500 hover:bg-blue-600 w-full">
                                    Add To Cart
                                </button>
                                ...
                                <div x-show="added" class="flex items-center space-x-2">
                                    ...
                                    <button @click="quantity++; updateCart({ id: {{ $food->id }}, quantity: quantity })"
                                        class="bg-gray-300 text-gray-700 px-3 py-1 rounded-lg">
                                        +
                                    </button>
                                </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6 flex flex-col justify-between max-h-128">
                ...
                <div class="border-t pt-4 mt-4">
                    ...
                    <button data-modal-target="authentication-modal" data-modal-toggle="authentication-modal"
                        class="bg-green-500 text-white px-4 py-2 rounded-lg w-full" type="button">
                        Checkout
                    </button>
                </div>
            </div>
    ...
    <div id="authentication-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative w-full max-w-lg mx-auto bg-white rounded-lg shadow-lg dark:bg-gray-800">
            <div class="flex items-start justify-between p-5 border-b border-gray-300 rounded-t dark:border-gray-700">
                ...
                <br>
                <button type=" button" class="text-gray-400 hover:text-gray-800 dark:hover:text-gray-200"
    ...
    $select_options = [
        ...
        '0' => 'Take Away',
                                                                                                                            ...
                                                                                                                            ?>
                        {{ html()->label($field_label, $field_name)->class('form-label text-gray-700 dark:text-gray-300') }}
            ...
            <div class=" px-6 py-1 ">
                <small class="text-gray-800 dark:text-gray-200">
                    (pembayaran hanya bisa dilakukan cash atau pembayaran tunai)
                </small>
            </div>
            <div class="flex items-center justify-between p-6 border-t border-gray-300 dark:border-gray-700">
                <button type="button"
                    class="bg-red-600 text-white py-2 px-4 rounded-md hover:bg-red-700 focus:outline-none focus:ring-4 focus:ring-red-300 dark:focus:ring-red-600"
                    data-modal-hide="authentication-modal">
                    Cancel
                </button>
                <button id="submit-order-button" type="button"
                    class="bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-600">
                    Selesai Order
                </button>
            </div>
        </div>
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <p class="text-lg font-semibold text-gray-900 dark:text-white">
                        {{ __('Please show this message to the cashier.') }}
                    </p>
                    <p class="text-lg font-semibold text-gray-900 dark:text-white">{{ __('Invoice: ') }}<span
                            id="invoice-number"></span></p>
                </div>
                <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                    <button id="success-modal-ok-button" type="button"
