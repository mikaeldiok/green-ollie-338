...
@section('content')
    ...
    <!-- Checkout Modal -->
    <div x-show="isCheckoutModalOpen" class="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-75" style="display: none;">
        <div class="bg-white p-6 rounded-lg max-w-lg w-full">
            ...
            <div class="flex justify-end space-x-4">
                <button @click="closeCheckoutModal" class="bg-gray-500 text-white px-4 py-2 rounded">{{ __('Cancel') }}</button>
    ...
    <script>
        function cart() {
            return {
                ...
                printReceipt() {
                    // Logic to print receipt goes here
